...
//
#define NUM_Z_STEPPER_DRIVERS 1   // (1-4) Z options change based on how many  ACT
 ...
 */
//#define Z_STEPPER_AUTO_ALIGN//ACTION Z Align
#if ENABLED(Z_STEPPER_AUTO_ALIGN)
  // Define probe X and Y positions for Z1, Z2 [, Z3 [, Z4]]
  // If not defined, probe limits will be used.
  // Override with 'M422 S<index> X<pos> Y<pos>'
  #define Z_STEPPER_ALIGN_XY { { 25, 100 }, { 190, 100 } }
   ...
   *               | 1   2 | 2   3 | 3   4 | 4   1 |
   */
  #ifndef Z_STEPPER_ALIGN_XY //ACT adjust Z align Z
 ...
 */
#define ADVANCED_PAUSE_FEATURE//disable for LVGL display
